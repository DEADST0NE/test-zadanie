      ...
      return (<Error />)
        ...
        <div className={s.categories}> 
          ...
          <div className={s.tabContent}>
            <Route path="/industries" component={() => <ItemTileList data={props.categories.industries}/> }/>
            <Route path="/organizations" component={() => <ItemTileList data={props.categories.organizations}/>} />
          </div> 
