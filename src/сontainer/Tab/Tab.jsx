    ...
    return (
        <div className={s.categories}> 
          ...
          <Tabs selectedTabClassName={s.active}>
            ...
            <TabPanel> <ItemTileList fun={ (id) => { props.getReportItemIndustry(id) } } data={TestData}/>  </TabPanel>
            <TabPanel> <ItemTileList fun={ (id) => { props.getReportItemOrganization(id) } }  data={TestData2}/> </TabPanel> 
            </div> 
